...
export function setupPlaceholderStage(inputTexture: GPUTexture, stageName: string): PipelineStage {
  return {
    outputTexture: inputTexture,
    encode() {
      console.warn(`${stageName} is a placeholder stage and is currently bypassed.`);
    },
  };
}

export function buildWhenContext(main: WhenSize, reference: WhenReferenceDimensions): WhenContext {
  return {
